...
def main(cfg):
    ...
    for metric_name in [
        ...
        "train/stats.left_clearance",
        "train/stats.front_clearance",
        "train/stats.right_clearance",
        ...
        "eval/stats.left_clearance",
        "eval/stats.front_clearance",
        "eval/stats.right_clearance",
        "auxiliary_loss",
        "auxiliary_future_progress_loss",
        "auxiliary_future_clearance_loss",
        "auxiliary_future_sector_clearance_loss",
        "auxiliary_future_left_clearance_loss",
        "auxiliary_future_front_sector_clearance_loss",
        "auxiliary_future_right_clearance_loss",
