...
def print_eval_metrics(eval_info, prefix="eval", label="eval"):
    metric_keys = [
        ...
        f"{prefix}/stats.reward_safety_static",
        f"{prefix}/stats.reward_safety_dynamic",
...
def main(cfg):
    ...
    for metric_name in [
        ...
        "train/stats.reward_safety_static",
        "train/stats.reward_safety_dynamic",
        ...
        "eval/stats.reward_safety_static",
        "eval/stats.reward_safety_dynamic",
