...
\begin{figure}[thpb]
	...
	\subfigcapskip=2pt 
		\subfigure[Static obstacles]{\figureplaceholder{0.47\columnwidth}{0.36\columnwidth}\label{fig_sim_static}
	}
		\subfigure[Dynamic obstacles]{\figureplaceholder{0.47\columnwidth}{0.36\columnwidth}\label{fig_sim_dynamic}
	}
	    \subfigure[Mixed obstacles]{\figureplaceholder{0.47\columnwidth}{0.36\columnwidth}\label{fig_sim_mixed}
	}
		\subfigure[Large non-convex structures]{\figureplaceholder{0.47\columnwidth}{0.36\columnwidth}\label{fig_sim_nonconvex}
	}
	\vspace{-1pt}
...
\begin{figure*}[thpb]
	...
	\subfigure[Static]{\figureplaceholder{0.44\columnwidth}{0.32\columnwidth}\label{fig_real_static}}\hfill
	\subfigure[Dynamic]{\figureplaceholder{0.44\columnwidth}{0.32\columnwidth}\label{fig_real_dynamic}}\hfill
	\subfigure[Mixed]{\figureplaceholder{0.44\columnwidth}{0.32\columnwidth}\label{fig_real_mixed}}\hfill
	\subfigure[Non-convex]{\figureplaceholder{0.44\columnwidth}{0.32\columnwidth}\label{fig_real_nonconvex}}
	\par\vspace{7pt}
	\subfigure[Linear velocity]{\figureplaceholder{1.82\columnwidth}{0.40\columnwidth}\label{fig_real_velocity}}
	\vspace{1pt}
