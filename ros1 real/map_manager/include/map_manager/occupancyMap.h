...
namespace mapManager{
	...
	protected:
		...
		double pointcloudMinRange_, pointcloudMaxRange_;
		int pointcloudStride_;
		bool selfFilterEnabled_;
		Eigen::Vector3d selfFilterMin_, selfFilterMax_;
		double pointcloudSyncMaxInterval_, pointcloudSyncLogInterval_;
		...
		bool visGlobalMap_;
		bool verbose_;
		bool enableStaticClustering_;
		bool enableVisualization_;
		bool useDynamicObstacleFreeRegions_;
		// -----------------------------------------------------------------
	...
	public:
		...
		bool getStaticObstacles(map_manager::GetStaticObstacles::Request& req, map_manager::GetStaticObstacles::Response& res);
		...
		void staticClusteringCB(const ros::TimerEvent& );
